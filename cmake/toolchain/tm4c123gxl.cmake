...
set(CMAKE_SYSTEM_NAME tm4c123gxl)
...
set(CMAKE_C_FLAGS_INIT "-mcpu=cortex-m4 -march=armv7e-m -mfpu=fpv4-sp-d16 -mfloat-abi=hard -ffunction-sections -fdata-sections -fno-common -fstack-usage -Wdouble-promotion -Wconversion -Wstack-usage=32000 -specs=nosys.specs -Wl,--gc-sections")
set(CMAKE_CXX_FLAGS_INIT "${CMAKE_C_FLAGS_INIT} -fno-exceptions -fno-rtti -fno-unwind-tables")
set(CMAKE_EXE_LINKER_FLAGS_INIT "-e Reset_Handler -T${CMAKE_CURRENT_LIST_DIR}/support/tm4c123gxl/tm4c123gxl.ld")

# Force the toolchain to generate ELF files
set(CMAKE_EXECUTABLE_SUFFIX_C   .elf)
set(CMAKE_EXECUTABLE_SUFFIX_CXX .elf)

# Add the target startup dependencies
include(${CMAKE_CURRENT_LIST_DIR}/support/tm4c123gxl/CMakeLists.txt)
